...
export default function VaHoy() {
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-xs" style={{ color: 'var(--muted)' }}>Marca cada tarea que hagas. Se te paga por cada casilla, según sus minutos.</p>

      <div className="space-y-2">
        {cuentas.map((c) => (
          <div key={c.id} className="rounded-xl p-3" style={{ backgroundColor: c.completada ? 'var(--gold-15)' : 'var(--surface)', border: `1px solid ${c.completada ? 'var(--gold-25)' : 'var(--border)'}` }}>
