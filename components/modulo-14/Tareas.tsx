...
import { Plus, Trash2, CheckCircle2, Circle, RotateCcw, CalendarDays } from 'lucide-react'
            ...
            return (
              <div key={t.id} className="flex items-start gap-3 rounded-xl border px-4 py-3"
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {t.descripcion && <p className="text-xs mt-0.5" style={{ color: '#6B6B80' }}>{t.descripcion}</p>}
