...
export const metadata = { title: 'Mis Ventas — Skeilab' }
    ...
    return (
      <div className="max-w-5xl mx-auto">
        <div className="flex items-start gap-3 mb-8">
          ...
          <div>
            <h1 className="text-xl font-bold" style={{ color: 'var(--foreground)' }}>Ventas reportadas por chatters</h1>
        ...
        {error ? (
          <div className="rounded-2xl border p-5 flex items-start gap-3"
            ...
            <div>
              ...
              <p className="text-xs" style={{ color: 'var(--muted)' }}>Ejecuta 008_ventas_chatter.sql en Supabase.</p>
            </div>
          </div>
        ) : (
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="flex items-start gap-3 mb-8">
        ...
        <div>
          <h1 className="text-xl font-bold" style={{ color: 'var(--foreground)' }}>Mis Ventas</h1>
          <p className="text-sm mt-0.5" style={{ color: 'var(--muted)' }}>
        ...
        <div className="rounded-2xl border p-5 flex items-start gap-3"
          ...
          <div>
            ...
            <p className="text-xs" style={{ color: 'var(--muted)' }}>
              Ejecuta <code className="px-1 py-0.5 rounded" style={{ backgroundColor: 'var(--border)' }}>supabase/migrations/008_ventas_chatter.sql</code> en Supabase.
            </p>
          </div>
        </div>
      ) : (
