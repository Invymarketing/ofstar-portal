...
export const metadata = { title: 'Programación de Telegram — Skeilab' }
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="flex items-start gap-3 mb-8">
        ...
        <div>
          <h1 className="text-xl font-bold" style={{ color: 'var(--foreground)' }}>Programación de Telegram</h1>
        ...
        <div className="rounded-2xl border p-5 flex items-start gap-3"
          ...
          <div>
            ...
            <p className="text-xs" style={{ color: 'var(--muted)' }}>
              Ejecuta <code className="px-1 py-0.5 rounded" style={{ backgroundColor: 'var(--border)' }}>supabase/migrations/013_mensajes_telegram.sql</code> en Supabase.
            </p>
          </div>
        </div>
      ) : (
