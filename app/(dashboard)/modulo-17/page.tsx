...
export const metadata = { title: 'Customs & Videollamadas — Skeilab' }
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="flex items-start gap-3 mb-8">
        ...
        <div>
          <h1 className="text-xl font-bold" style={{ color: 'var(--foreground)' }}>Customs & Videollamadas</h1>
      ...
      {!tablaLista ? (
        <div className="rounded-2xl border p-5" style={{ backgroundColor: 'rgba(234,179,8,0.05)', borderColor: 'rgba(234,179,8,0.2)' }}>
          ...
          <p className="text-xs mt-1" style={{ color: 'var(--muted)' }}>
            Ejecuta <code className="px-1 py-0.5 rounded" style={{ backgroundColor: 'var(--border)' }}>024_custom_vc.sql</code> en Supabase para activar este módulo.
          </p>
        </div>
      ) : (
        <CustomVC
